...
@section('content')
    <div class="container">
    	...
    	<br>
    	{{ Form::open(array('method' => 'post', 'action'=> 'WorkOrderController@store', 'id' => 'nueva-ot', 'autocomplete' => 'off' )) }}
    		<div class="row">
    			<div class="col-lg-12">
    		...
    		<div class="row">
    			<div class="col-lg-12 text-center">
    				{{ Form::submit('Crear',array('class' => 'btn btn-success btn-lg','id' => 'btn-nueva-ot')) }}
    			</div>
    		</div>
            <br>
    	{{ Form::close() }}
